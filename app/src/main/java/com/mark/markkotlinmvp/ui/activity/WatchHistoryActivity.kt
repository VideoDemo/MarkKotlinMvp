...
import com.mark.markkotlinmvp.ui.adapter.WatchHistoryAdapter
...
class WatchHistoryActivity : BaseActivity() {
    ...
    private fun queryWatchHistory(): ArrayList<HomeBean.Issue.Item> {
        ...
        val hisAll = WatchHistoryUtils.getAll(Constants.FILE_WATCH_HISTORY_NAME, MarkApp.context) as Map<*, *>
        //将key排序升序
        ...
        (1..hisLength).mapTo(watchList) {
            WatchHistoryUtils.getObject(Constants.FILE_WATCH_HISTORY_NAME, MarkApp.context,
