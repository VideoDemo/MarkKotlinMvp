...
import com.mark.markkotlinmvp.mvp.contract.VideoDetailContract
import com.mark.markkotlinmvp.mvp.model.bean.HomeBean
import com.mark.markkotlinmvp.mvp.presenter.VideoDetailPresenter
import com.mark.markkotlinmvp.showToast
import com.mark.markkotlinmvp.ui.adapter.VideoDetailAdapter
import com.mark.markkotlinmvp.utils.CleanLeakUtils
import com.mark.markkotlinmvp.utils.StatusBarUtil
import com.mark.markkotlinmvp.utils.WatchHistoryUtils
import com.mark.markkotlinmvp.view.VideoListener
...
class VideoDetailActivity : BaseActivity(), VideoDetailContract.View {
    ...
    private fun saveWatchVideoHistoryInfo(watchItem: HomeBean.Issue.Item) {
        ...
        val historyMap = WatchHistoryUtils.getAll(Constants.FILE_WATCH_HISTORY_NAME,MarkApp.context) as Map<*, *>
        for ((key, _) in historyMap) {
            if (watchItem == WatchHistoryUtils.getObject(Constants.FILE_WATCH_HISTORY_NAME,MarkApp.context, key as String)) {
                WatchHistoryUtils.remove(Constants.FILE_WATCH_HISTORY_NAME,MarkApp.context, key)
            }
        }
        WatchHistoryUtils.putObject(Constants.FILE_WATCH_HISTORY_NAME,MarkApp.context, watchItem,"" + mFormat.format(Date()))
    }
