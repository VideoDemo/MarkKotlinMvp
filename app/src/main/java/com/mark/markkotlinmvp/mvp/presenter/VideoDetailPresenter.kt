...
import com.mark.markkotlinmvp.dataFormat
import com.mark.markkotlinmvp.mvp.contract.VideoDetailContract
import com.mark.markkotlinmvp.mvp.model.VideoDetailModel
...
import com.mark.markkotlinmvp.utils.DisplayManager
...
class VideoDetailPresenter : BasePresenter<VideoDetailContract.View>(), VideoDetailContract.Presenter {
    ...
    override fun loadVideoInfo(itemInfo: HomeBean.Issue.Item) {
        ...
        val netType = NetworkUtil.isWifi(MarkApp.context)
        // 检测是否绑定 View
        checkViewAttached()
        if (playInfo!!.size > 1) {
